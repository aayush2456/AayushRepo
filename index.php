            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-sm-6 col-6 header-top-left">
                        <ul>
                            <li><a href="index.php">Visit Us</a></li>
                            <li><a href="https://www.esewa.com.np/#/home"target="_blank">Buy Tickets</a></li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="row fullscreen align-items-center justify-content-between">
                <div class="col-md-6 banner-left">
                    ...
                    <h1 class="text-white">Roam Nepal</h1>
                    <h6 class="text-white mb-3">
                      Get information about your dream destination form home.
                    </h6>
                    <a href="#trending" class="btn btn-info btn-lg text-uppercase smooth-scroll">Explore Nepal</a>
                </div>
